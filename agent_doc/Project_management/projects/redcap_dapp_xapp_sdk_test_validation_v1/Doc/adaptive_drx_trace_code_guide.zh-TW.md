...
Runtime `policy_version` 是送至 gNB 的 network RIC request ID，不是
xApp-local `e42_request_id`，也不一定等於 predictor 原先規劃的 window number。
...
| 11 | [`run_campaign.py:433`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L433)，baseline branch；[`run_campaign.py:474`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L474)，Arm B window branch | 固定 Arm A baseline 或 Arm B intent | 一個 Arm A version 或十個 scored Arm B versions | 無 | Local telnet 或 SWIG |
| 12A | [`run_campaign.py:277`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L277)，`_send_local_drx_policy()` | C-RNTI 與 profile | Arm A version 1 或 fresh-state Arm B bootstrap version 0 | gNB staged/applied | 步驟 20 |
| 12B | [`run_campaign.py:498`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L498)，`ric.control_drx_sm()` | Arm B node、RRC UE ID、long cycle | 正值的本地 `e42_request_id`；network version 由 marker 解析 | Caller 無 marker | SWIG wrapper |
| 13 | [`swig_wrapper.cpp:459`](../../../../../openair2/E2AP/flexric/src/xApp/swig/swig_wrapper.cpp#L459)，`control_drx_sm()` | E2 node、`rrc_ue_id`、cycle | 同步 RC control 與 xApp-local E42 request ID | Generic FlexRIC response | C xApp request builder |
...
| 20 | [`ran_func_rc.c:99`](../../../../../openair2/E2AP/RAN_FUNCTION/O-RAN/ran_func_rc.c#L99)，`apply_redcap_drx_control()` | Cycle、network RIC request ID、UE state | Narrow dApp request 與 accepted gNB profile | `[dApp ACCEPT]` 或 `[dApp REJECT]` | `nr_mac_apply_drx_policy()` |
...
| 28 | [`nr_ue_drx.c`](../../../../../openair2/LAYER2/NR_MAC_UE/nr_ue_drx.c)，`nr_ue_drx_is_active()` | Slot、SR、inactivity、RA 與 HARQ timers | Active decision 與 persistent packed counters | `ciUE drx_stats` 的 `[UE stats]` | UE PDCCH gate |
...
| 34 | [`run_campaign.py:249`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L249)，`_wait_for_new_commit()` | Runtime log 與 network request ID | 只有完整 versioned marker chain 才成功 | Expire 時 `[control timeout]` | `predictor.resolve()` |
| 35 | [`run_campaign.py:516`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L516)，resolve/record branch | Commit 與 traffic results | 成功清除；失敗保存完整 30-sample evidence；metrics/summary | PASS/PARTIAL | Checker |
...
| 缺少 completion marker | `run_campaign._wait_for_new_commit()` | Predictor 保留 30 筆 samples | `[control timeout]`、PARTIAL |
