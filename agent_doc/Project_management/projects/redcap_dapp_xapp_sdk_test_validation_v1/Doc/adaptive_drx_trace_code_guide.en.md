...
source location. Runtime `policy_version` is the network RIC request ID carried
to the gNB, not the xApp-local `e42_request_id` or necessarily the predictor's
planned window number.
...
| 12A | [`run_campaign.py:277`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L277), `_send_local_drx_policy()` | C-RNTI and profile | Arm A version 1 or fresh-state Arm B bootstrap version 0 | gNB staged/applied | Step 20 |
| 12B | [`run_campaign.py:498`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L498), `ric.control_drx_sm()` | Arm B node, RRC UE ID, long cycle | Positive local `e42_request_id`; network version is resolved from markers | None at caller | SWIG wrapper |
| 13 | [`swig_wrapper.cpp:459`](../../../../../openair2/E2AP/flexric/src/xApp/swig/swig_wrapper.cpp#L459), `control_drx_sm()` | E2 node, `rrc_ue_id`, cycle | Synchronous RC control and xApp-local E42 request ID | Generic FlexRIC response | C xApp request builder |
...
| 20 | [`ran_func_rc.c:99`](../../../../../openair2/E2AP/RAN_FUNCTION/O-RAN/ran_func_rc.c#L99), `apply_redcap_drx_control()` | Cycle, network RIC request ID, UE state | Narrow dApp request and accepted gNB profile | `[dApp ACCEPT]` or `[dApp REJECT]` | `nr_mac_apply_drx_policy()` |
...
| 34 | [`run_campaign.py:249`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L249), `_wait_for_new_commit()` | Runtime log and network request ID | Success only after full versioned marker chain | `[control timeout]` on expiry | `predictor.resolve()` |
| 35 | [`run_campaign.py:516`](../../../../../agent_doc/Project_management/projects/redcap_dapp_xapp_sdk_test_validation_v1/scripts/adaptive_drx/run_campaign.py#L516), resolve/record branch | Commit and traffic results | Clear on success; persist exact 30-sample failure evidence; metrics/summary | PASS/PARTIAL | Checker |
...
| Missing completion marker | `run_campaign._wait_for_new_commit()` | Predictor retains the 30 samples | `[control timeout]`, PARTIAL |
