...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_case-b_disabled_2026-04-29_12-26-31.log`
- [Expected CORESET#0 Mode]：`case-b`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_case-b_disabled_2026-04-29_12-26-31.yaml`
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  314490.011935 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-b-edge-only
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  314490.011939 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：未在 gNB log 中找到
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 1 筆範例
  314513.102769 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [Expected CORESET#0 mode]：找到 1 筆範例
  314490.011935 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-b-edge-only
- [Case B edge-aligned PRB allocation]：找到 1 筆範例
  314490.011933 [NR_MAC] I RedCap CORESET#0 Case B edge-aligned PRB allocation: start=0 size=51 carrier_bw=106 common_coreset_id=1
...
- [UE applied RedCap initial DL BWP]：找到 3 筆範例
  314515.877432 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
  314515.969434 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
  314516.054237 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 3 筆範例
  314515.877434 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
  314515.969435 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
  314516.054238 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
