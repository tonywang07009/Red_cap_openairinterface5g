...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_2026-04-12_13-48-08.log`
...
- [Attach UE2 RedCap] `333332`：[OK] Attach OAI UE 2 (RedCap)
  ...
  [Artifacts]：[none]
- [Verify UE2 RedCap] `302002`：[KO] Verify UE 2 is RedCap
  [Artifacts]：[none]
...
- [SIB1 RedCap initial DL BWP]：未在 gNB log 中找到
- [SIB1 RedCap initial UL BWP]：未在 gNB log 中找到
