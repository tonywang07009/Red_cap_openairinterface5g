...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_2026-04-26_19-55-09.log`
...
- [Apply E2/xApp RedCap UL PRB cap] `302005`：[KO] Apply RedCap UL PRB cap to UE 2 via FlexRIC RC control
  ...
  [Build Log] /home/tonywang/OAI/Red_cap_openairinterface5g/test_log/build_logs/redcap_ul_prb_ctrl_xapp_build_2026-04-26_19-57-52.log
  # mode=live
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  82207.348072 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  82207.348076 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  82233.199171 [MAC]    I UE with RNTI 1544 is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  82230.439430 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  82233.199202 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  82233.192685 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  82233.192686 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
