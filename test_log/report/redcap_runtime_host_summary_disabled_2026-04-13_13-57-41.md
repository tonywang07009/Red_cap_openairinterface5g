...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_disabled_2026-04-13_13-57-41.log`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_disabled_2026-04-13_13-57-41.yaml`
...
- [Attach UE1] `333331`：[OK] Attach OAI UE 1
  ...
  [Artifacts]：[none]
- [Verify UE1 non-RedCap] `302001`：[KO] Verify UE 1 is normal (no RedCap)
  [Artifacts]：[none]
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  358367.914061 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  358367.914065 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  358391.361824 [MAC]    I UE with RNTI 6f17 is RedCap
...
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  358391.350468 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  358391.361834 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  358391.353544 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  358391.353545 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
