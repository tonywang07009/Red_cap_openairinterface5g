...
| `test_logs/work_daily/*.md` | 175 | Append-only session continuity records |
...
| `test_logs/work_daily/` | Preserve | `AGENTS.md`, `project_plan.md`, validation rule | Append-only session continuity store |
