...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_disabled_2026-04-13_14-19-41.log`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_disabled_2026-04-13_14-19-41.yaml`
...
- [Ping both UEs] `020005`：[KO] Ping ext-dn from both UEs
  ...
  RTT(Avg)   : 6.101 ms
  RTT(Max)   : 7.968 ms
           UE rfsim5g_redcap_ue2 (10.0.0.2): Ping RTT_Min RTT_Avg RTT_Max Not Found!
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  359564.226435 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  359564.226440 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  359587.593403 [MAC]    I UE with RNTI 3d3f is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  359587.593413 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  359587.620916 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  359587.586513 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  359587.586515 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
