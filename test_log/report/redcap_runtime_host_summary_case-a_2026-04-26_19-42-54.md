...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_case-a_2026-04-26_19-42-54.log`
- [Expected CORESET#0 Mode]：`case-a`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap.case-a.2026-04-26_19-42-54.yaml`
...
- [Apply E2/xApp RedCap UL PRB cap] `302005`：[KO] Apply RedCap UL PRB cap to UE 2 via FlexRIC RC control
  /bin/bash: line 1: ci-scripts/redcap_send_ul_prb_control.sh: No such file or directory
  [Artifacts]：[none]
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  81461.715169 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  81461.715173 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  81541.233562 [MAC]    I UE with RNTI 0cc1 is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 3 筆範例
  81484.808541 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  81538.325995 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  81541.233585 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [RedCap UL PRB control applied]：未在 gNB log 中找到
- [Expected CORESET#0 mode]：找到 1 筆範例
  81461.715169 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [Case A type0 CSS marker]：找到 1 筆範例
  81461.715167 [NR_MAC] I RedCap CORESET#0 Case A type0 CSS: start=0 size=51 coreset0=10 searchSpace0=0
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  81541.226097 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  81541.226098 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
