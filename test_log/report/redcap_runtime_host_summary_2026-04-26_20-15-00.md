...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_2026-04-26_20-15-00.log`
...
- [Apply E2/xApp RedCap UL PRB cap] `302005`：[OK] Apply RedCap UL PRB cap to UE 2 via FlexRIC RC control
  [Artifacts]：[none]
- [Verify gNB applied RedCap UL PRB cap] `302006`：[KO] Verify gNB applied RedCap UL PRB cap
  [Artifacts]：[none]
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  83397.903619 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  83397.903623 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  83423.739850 [MAC]    I UE with RNTI 50f2 is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  83420.994354 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  83423.739867 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [RedCap UL PRB control applied]：找到 1 筆範例
  RedCap UL PRB control RNTI 50f2 requested 32 effective 32
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  83423.733703 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  83423.733704 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
