...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_disabled_2026-04-13_14-45-09.log`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_disabled_2026-04-13_14-45-09.yaml`
...
- [Ping both UEs] `020005`：[KO] Ping ext-dn from both UEs
  ...
  RTT(Max)   : 8.148 ms
           UE rfsim5g_redcap_ue2 (10.0.0.2)
  [Artifacts]：16-020005-ping_rfsim5g_redcap_ue1.log, 16-020005-ping_rfsim5g_redcap_ue2.log
...
## gNB Log Cross-Check
- [gNB log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/cmake_targets/log/container_5g_flexric_rfsim_redcap.xml.d/26-100009-oai-gnb.logs`
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  redCapInitialBWP_r17:
  360734.648272 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  360734.648278 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  360758.052047 [MAC]    I UE with RNTI e4f6 is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  360758.052055 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  360758.062883 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [RedCap UL PRB control applied]：在 [REDCAP_E2_AGENT_MODE=disabled] host health-check 中屬於 [N/A]

## UE2 Log Cross-Check
- [UE2 log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/cmake_targets/log/container_5g_flexric_rfsim_redcap.xml.d/26-100009-oai-nr-ue2.logs`
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  360758.045572 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  360758.045573 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51

## E2 Disabled Cross-Check
- [xApp log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/cmake_targets/log/container_5g_flexric_rfsim_redcap.xml.d/26-100009-xapp-rc-moni.logs`
...
- [nearRT-RIC log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/cmake_targets/log/container_5g_flexric_rfsim_redcap.xml.d/26-100009-nearRT-RIC.logs`
