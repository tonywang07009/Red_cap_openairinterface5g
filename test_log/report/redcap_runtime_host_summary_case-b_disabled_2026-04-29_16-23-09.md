...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_case-b_disabled_2026-04-29_16-23-09.log`
- [Expected CORESET#0 Mode]：`case-b`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_case-b_disabled_2026-04-29_16-23-09.yaml`
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  328687.656188 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-b-edge-only
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  328687.656192 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：未在 gNB log 中找到
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 1 筆範例
  328710.725859 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [Expected CORESET#0 mode]：找到 1 筆範例
  328687.656188 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-b-edge-only
- [Case B edge-aligned PRB allocation]：找到 1 筆範例
  328687.656186 [NR_MAC] I RedCap CORESET#0 Case B edge-aligned PRB allocation: start=0 size=51 carrier_bw=106 common_coreset_id=1
...
- [UE applied RedCap initial DL BWP]：找到 3 筆範例
  328713.569622 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
  328713.657707 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
  328713.743939 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 3 筆範例
  328713.569623 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
  328713.657708 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
  328713.743940 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
