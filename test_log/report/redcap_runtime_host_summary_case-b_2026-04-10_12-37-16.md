...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_case-b_2026-04-10_12-37-16.log`
- [Expected CORESET#0 Mode]：`case-b`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap.case-b.2026-04-10_12-37-16.yaml`
...
- [Expected CORESET#0 mode] 應與 `mode=case-b` 一致。
