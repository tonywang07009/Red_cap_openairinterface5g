...
- [Run Log]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/compiler_logs/redcap_runtime_host_case-a_disabled_2026-05-07_13-05-52.log`
- [Expected CORESET#0 Mode]：`case-a`
- [gNB Config]：`/home/tonywang/OAI/Red_cap_openairinterface5g/test_log/runtime_configs/gnb.redcap_case-a_disabled_2026-05-07_13-05-52.yaml`
...
- [SIB1 RedCap initial DL BWP]：找到 2 筆範例
  ...
  613328.837231 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [SIB1 RedCap initial UL BWP]：找到 2 筆範例
  initialULPUCCH_ResourceCommonRedCap_r17: 0
  613328.837235 [NR_RRC] I SIB1 RedCap initial UL BWP: start=0 size=51 scs=1 pucch_ResourceCommonRedCap=0
- [UE marked as RedCap]：找到 1 筆範例
  613354.727776 [MAC]    I UE with RNTI 7e9a is RedCap
- [Legacy PUCCH budget assert]：未在 gNB log 中找到
- [BWP-fit PUCCH budget marker]：找到 2 筆範例
  613351.953890 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
  613354.727800 [NR_RRC] I Reducing PUCCH reservation budget from 64 to 43 UEs for BWP with 51 PRBs (PUCCH2 per slot 1)
- [Expected CORESET#0 mode]：找到 1 筆範例
  613328.837231 [NR_RRC] I SIB1 RedCap initial DL BWP: start=0 size=51 scs=1 coreset0=10 searchSpace0=0 mode=case-a-full-cell
- [Case A type0 CSS marker]：找到 2 筆範例
  613328.835936 [NR_MAC] I RedCap CORESET#0 Case A type0 CSS: start=0 size=51 coreset0=10 searchSpace0=0
  613328.837229 [NR_MAC] I RedCap CORESET#0 Case A type0 CSS: start=0 size=51 coreset0=10 searchSpace0=0
...
- [UE applied RedCap initial DL BWP]：找到 1 筆範例
  613354.721256 [NR_MAC] I Applying SIB1 RedCap initial DL BWP: start=0 size=51
- [UE applied RedCap initial UL BWP]：找到 1 筆範例
  613354.721258 [NR_MAC] I Applying SIB1 RedCap initial UL BWP: start=0 size=51
