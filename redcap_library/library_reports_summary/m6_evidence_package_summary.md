...
- [Milestone checklist]: `redcap_doc/checklists/redcap_milestone_validation_checklist.md`.
...
| M3 BWP / CORESET / RA | PASS | Case A/B RFsim evidence | Summary reports preserved for Case A and Case B |
...
|-----------|------------------|--------|
| M3 | `redcap_library/library_reports_summary/m3t2_coreset0_case_matrix_report.md` | PASS |
| M3 | `redcap_library/library_reports_summary/m3t2_redcap_rach_feature_partition_report.md` | PASS |
| M4-B | `redcap_library/library_reports_summary/m4b_lowpower_boundary_report.md` | PASS |
| M5 30 UE | `redcap_library/library_reports_summary/m5_caseb_30ue_pass_report.md` | PASS |
| M5 32 UE | `redcap_library/library_reports_summary/m5_caseb_32ue_pass_report.md` | PASS |
| M5 48 UE | `redcap_library/library_reports_summary/m5_caseb_48ue_pass_report.md` | PASS |
| M5 56 UE | `redcap_library/library_reports_summary/m5_caseb_56ue_static_cn_pass_report.md` | PASS |
| M5 64 UE | `redcap_library/library_reports_summary/m5_caseb_64ue_static_cn_threshold_report.md` | CLASSIFIED |
