...
CONTROL_CONTRACT_FILE=${REDCAP_CONTROL_CONTRACT_FILE:-${REPO_ROOT}/redcap_interface/control/redcap_control_contract.yaml}
POLICY_HOST_FILE=${REDCAP_POLICY_HOST_FILE:-${REPO_ROOT}/redcap_interface/control/redcap_policy_case_b.yaml}
