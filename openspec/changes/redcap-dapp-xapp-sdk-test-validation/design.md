...
- [Staged gates] Use Gate A-E: SDK unit, SWIG, E3 loopback, small RFsim, and 56 UE / 5 PRB BWP stress. This prevents a 56 UE failure from hiding whether the problem is SDK logic, E3 binding, or RFsim scale.
...
- [Risk] 5 PRB BWP can fail because PUCCH resources are too constrained. -> Mitigation: treat 56 UE / 5 PRB as a stress gate and record scheduler/config failure separately from SDK failure.
